...
export function InviteStaffDialog({ orgId, orgName, trigger }: InviteStaffDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Enviale un correo al miembro para que acepte la invitacion al restaurante.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
